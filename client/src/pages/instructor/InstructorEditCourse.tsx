...
import { editCourse, getCategoryies, getCourses } from "../../Api/instructor";
...
const InstructorEditcourse: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!sections[0].lectures[0].content.video_url) {
      return toast.error("Please provide all Deatailes...");
    }
    setLoading(true);
  ...
  const deleteLecture = (sectionId: number, lectureId: number) => {
    const data = sections.map((sec, index) => {
      if (index === sectionId) {
        return {
          ...sec,
          lectures: sec.lectures.filter((_lec, idx) => idx !== lectureId), // ✅ Remove lecture
        };
      }
      return sec;
    });
      ...
      if (index == sectionId) {
        return {
          ...
          lectures: [
            ...(sec.lectures || []),
            {
              id: sec.lectures.length.toString(),
              duration: "",
              title: "",
              content: { _id: sec.lectures.length.toString(), video_url: "" },
            },
          ],
        };
      } else {
  ...
  const deleteSection = (sectionId: number) => {
    console.log(sectionId, sections.length == 1);

    if (sections.length == 1) {
      return toast.error("Please upload atleast one section for yor course");
    }
                            ...
                            {sections.map((section, index) => (
                              ...
                              >
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <div className="flex gap-2 ml-2 my-auto">
                                    <i
                      ...
                      <CardContent>
                        ...
                        <FormDescription>
                          {errors.title ? (
                            ...
                            <span>
                              This is your public display Title.And the Minimum
                              length of your course Title should be 3 and
                        ...
                        <div className="grid grid-cols-3 gap-1">
                          <div>
                            ...
                            >
                              <SelectTrigger className="w-full rounded-full text-white border-1 border-white-900">
                        ...
                        <FormDescription>
                          {errors.thumbnail && (
                            <div className="text-danger">
                              Minimum length of the Thumbnail should be 10..
                            </div>
                          )}
                        </FormDescription>
                        {errors.description ? (
                        ...
                        <FormDescription className="text-danger pt-2">
                          {errors.description && (
                            <>
                              "Minimum length of the Desciption should be 10..
                            </>
                          )}
                        </FormDescription>
                      </CardContent>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Do you wnat to save theis changes? it will store out
                          server permenently.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
