...
const InstructorEditTest = () => {
  ...
  const handleEditTest = (data: TestFormInputs) => {
    //  setLoading(true)
    console.log(data);
    doRequest({
        ...
        <div className="p-2 space-y-2">
          <div className=" flex flex-col items-center w-full">
            <div className=" text-center text-sm text-black ">
              <div className="font-extrabold text-3xl underline">Edit Test</div>
                  ...
                  <CarouselItem key={index}>
                    <Card className=" text-black">
                      <CardContent>
                        ...
                        <form
                          className="space-y-3"
                          onSubmit={handleSubmit(handleEditTest, onError)}
                        >
                          <div>
                            <textarea
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      This data you entered will be stored to
                                      Eduhub servers
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
                                    ...
                                    <AlertDialogCancel
                                      ...
                                      type="submit"
                                      onClick={() =>
                                        handleSubmit(handleEditTest, onError)()
                                      }
                                    >
                                      Continue
                                    </AlertDialogCancel>
...
export default React.memo(InstructorEditTest);
