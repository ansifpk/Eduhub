  ...
  return (
    <div className='shadow-md  w-full fixed top-0 left-0 z-50'>
      <div className='md:flex bg-teal-500 items-center  justify-between md:px-10 px-7'>
        ...
        <ul className={`md:flex md:items-center  md:pb-0  pb-12 absolute md:static md:bg-teal-500 bg-teal-500    left-0 w-full md:w-auto md:pl-0 pl-9 transition-all durtion-500 ease-in ${open?'top-8':'top-[-490px]'} md:opasity-100 opasity-0`}>
