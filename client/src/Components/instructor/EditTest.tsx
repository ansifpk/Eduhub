...
const EditTest = () => {
    ...
    useEffect(()=>{
        doRequest({
            url:`${instructorRoutes.testDetailes}/${testId}`,
            body:{},
            method:"get",
            onSuccess:(response)=>{
               setQuestions(response.test.test)
            }
        });
    },[testId]);
    ...
    const handleQuestionChange = (
      ...
      const editTest = async () => {
        ...
        if (!success) {
          ...
          doRequest({
              url:`${instructorRoutes.tests}/${testId}`,
                                              ...
                                              <div>
                                                <div className="grid    gap-1.5">
                                                  ...
                                                  <Textarea
                                                    ...
                                                    id="message-2"
                                                  />
                                                   {error[index].question? <p className="text-sm text-red-600 ">
                                                  ...
                                                  <div className="flex gap-3 items-center">
                                                    <div className="grid w-full gap-1.5">
                                                      ...
                                                      onChange={(e)=>handleQuestionChange(index,"option1","option1",e.target.value)}
                                                        ...
                                                        id="Option1"
                                                      />
                                                      {error[index].option1&& <p className="text-sm text-red-600 ">
                                                        This field is required
                                                        </p>}
                                                    </div>
                                                    <div className="grid w-full gap-1.5">
                                                      ...
                                                      value={questions[index].option2}
                                                       ...
                                                       onChange={(e)=>handleQuestionChange(index,"option2","option2",e.target.value)}
                                                        ...
                                                        id="message-2"
                                                      />
                                                       {error[index].option2&& <p className="text-sm text-red-600 ">
                                                        This field is required
                                                        </p>}
                                                    </div>
                                                  </div>
                                                    ...
                                                    <div className="grid w-full gap-1.5">
                                                      ...
                                                      <Input
                                                       ...
                                                       onChange={(e)=>handleQuestionChange(index,"option3","option3",e.target.value)}
                                                        ...
                                                        id="Option1"
                                                      />
                                                       {error[index].option3&& <p className="text-sm text-red-600 ">
                                                        This field is required
                                                        </p>}
                                                    </div>
                                                    <div className="grid w-full gap-1.5">
                                                      ...
                                                      <Input
                                                       ...
                                                       onChange={(e)=>handleQuestionChange(index,"option4","option4",e.target.value)}
                                                        ...
                                                        id="message-2"
                                                      />
                                                       {error[index].option4&& <p className="text-sm text-red-600 ">
                                                        This field is required
                                                        </p>}
                                                    </div>
                                                  </div>
                                                    ...
                                                    <div className="grid w-50 gap-1.5">
                                                      ...
                                                      <Input
                                                       ...
                                                       onChange={(e)=>handleQuestionChange(index,"answer","answer",e.target.value)}
                                                        ...
                                                        id="message-2"
                                                      />
                                                       {error[index].answer&& <p className="text-sm text-red-600 ">
                                                        This field is required
                                                      </p>}
                                                    </div>
                                                  </div>
                                                  {current==5&&<div className="flex justify-center mt-4">
                                                    <Button type="submit" className="bg-white text-black hover:bg-white hover:text-black" onClick={editTest}>Edit</Button>
                                                 </div>}
                                                </div>
                                              </div>
                                            </CardContent>
