...
export interface IAdminUseCase{
   ...
   createCoupon(title:string,description:string,offer:number,startingDate:string,expiryDate:string,couponCode:string,next:NextFunction):Promise<ICoupon|void>
   editCoupon(couponId:string,title:string,description:string,offer:number,startingDate:string,expiryDate:string,couponCode:string,next:NextFunction):Promise<ICoupon|void>
   ...
   getCoupons(search:string,sort:string,page:string,next:NextFunction):Promise<ICoupon[]|void>
