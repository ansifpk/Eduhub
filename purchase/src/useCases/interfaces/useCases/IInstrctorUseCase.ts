...
export interface IInstructorUseCase{
    getOrders(userId:string,report:string,year:string,month:string,next:NextFunction):Promise<IOrder[]|void>
    ...
    instructorOrders(userId:string,next:NextFunction):Promise<IOrder[]|void>
}