...
const PurchasedCourses = React.lazy(
  () => import("@/pages/user/PurchasedCourses")
);
...
const InstructorProfile = React.lazy(
  () => import("@/pages/user/InstructorProfile")
);
...
const SubscriptionSuccess = React.lazy(
  () => import("@/pages/user/SubscriptionSuccess")
);
    ...
    <Suspense fallback={<>loading....</>}>
      <Routes>
        ...
        <Route
          path="/forgetPassword"
          element={
            userId ? <Navigate to={"/signIn"} replace /> : <ForgetPassword />
          }
        />
        <Route
          path="/signUp"
          element={userId ? <Navigate to={"/"} replace /> : <Regitser />}
        />
        <Route
          path="/signIn"
        ...
        <Route
          path="/user/otp/:email"
          element={userId ? <Navigate to={"/"} replace /> : <Otp />}
        />
        <Route
          path="/user/cart"
          element={userId ? <Cart /> : <Navigate to={"/signIn"} replace />}
        />
        <Route
          path="/user/playCourse/:courseId"
          element={
            userId ? <PlayCourse /> : <Navigate to={"/signIn"} replace />
          }
        />
        <Route
          path="/user/courseDetailes/:_id"
          element={
            userId ? <CourseDetailes /> : <Navigate to={"/signIn"} replace />
          }
        />
        <Route
          path="/user/profile"
          element={userId ? <Profile /> : <Navigate to={"/signIn"} replace />}
        />
        <Route
          path="/user/profile/course"
          element={
            userId ? <PurchasedCourses /> : <Navigate to={"/signIn"} replace />
          }
        />
        <Route
          path="/user/profile/message"
          element={userId ? <Message /> : <Navigate to={"/signIn"} replace />}
        />
        <Route
          path="/user/profile/coupon"
          element={userId ? <Coupon /> : <Navigate to={"/signIn"} replace />}
        />
        <Route
          path="/user/profile/plan"
          element={userId ? <Plan /> : <Navigate to={"/signIn"} replace />}
        />
        <Route
          path="/user/profile/settings"
          element={userId ? <Settings /> : <Navigate to={"/signIn"} replace />}
        />
        <Route
          path="/user/instructorProfile/:instructorId"
          element={
            userId ? <InstructorProfile /> : <Navigate to={"/signIn"} replace />
          }
        />
        <Route
          path="/user/changeEmail"
          element={
            userId ? <ChangeEmail /> : <Navigate to={"/signIn"} replace />
          }
        />
        <Route
        ...
        />
        <Route
          path="/user/subscription/faile"
          element={
            userId ? <SubscriptionFaile /> : <Navigate to={"/signIn"} replace />
          }
        />
        <Route
          path="/user/success"
          element={userId ? <Success /> : <Navigate to={"/signIn"} replace />}
        />
        <Route
          path="/user/faile"
        ...
        <Route
          path="*"
          element={
            userId ? <UserErrorPage /> : <Navigate to={"/signIn"} replace />
          }
        />
      </Routes>
    </Suspense>
