...
const InstructorProfile = () => {
  ...
  return (
    <div>
      <Header />
      <div className="p-5">
        <div className="flex md:flex-row flex-col justify-center items-center space-y-2 gap-2">
                            ...
                            <div className=" text-sm m-2 grid space-y-2 ">
                              ...
                              <div className="flex flex-col gap-2">
                                <button
                                  ...
                                  className="bg-teal-500 py-2 rounded w-full font-semibold text-white cursor-pointer hover:bg-teal-300 transition-all hover:scale-105"
                                >
                                  View Detailes
                                </button>
                                <button
                                  ...
                                  className="bg-teal-500 py-2 rounded transition-all hover:scale-105 cursor-pointer font-semibold text-sm w-full text-white hover:bg-teal-300"
                                >
                                  {course.students.some(
                                    (student) => student._id == userId
                                  ) ||
