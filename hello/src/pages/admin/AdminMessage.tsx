        ...
        <main className="w-full flex justify-center items-center md:p-8 p-3">
          <div className="w-full border-2 rounded h-[70vh]">
            <div className="w-full flex rounded  gap-1">
              <div className="w-[35%] flex justify-between border bg-purple-500 p-3">
              ...
              <div className="w-[65%] bg-purple-500 border p-2 rounded">
                {currentChat && (
                ...
                {chats.map((chat) => {
                  ...
                  return (
                    <div
                      ...
                      className="relative cursor-pointer flex items-center gap-2 p-2 border border-purple-500"
                    >
                      <Avatar>
                        <AvatarImage
                          src={
